...
class Dashboard(tk.Tk):
    ...
    def _creer_observateurs(self) -> None:
        ...
        self._compteur_session = CompteurSessions(self)
        self._logger_session = LoggerSession("pomodoro.log")
    ...
    def _abonner_observateurs(self) -> None:
        ...
        self._minuteur.abonner(self._compteur_session)
    ...
    def _pause(self) -> None:
        ...
        if self._minuteur.get_donnees()["en_pause"]:        
    ...
    def _tick(self) -> None:
        ...
        if self._en_marche and not self._minuteur.get_donnees()["en_pause"]:
            self._minuteur.tick()
